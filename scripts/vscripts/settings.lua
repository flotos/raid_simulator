...
RUNE_SPAWN_TIME = 9999                   -- How long in seconds should we wait between rune spawns?
...
MAX_LEVEL = 18                          -- What level should we let heroes get to?
...
VICTORY_MESSAGE_DURATION = 0.5            -- How long should we wait after the victory message displays to show the End Screen?  Use 
...
-- Boss Rewards :
-- RAID_BOSS_REWARDS[round] = {gold, xp, score}
-- ------------------------------------
RAID_BOSS_REWARDS = {}
RAID_BOSS_REWARDS[1] = {5, 100, 10}
RAID_BOSS_REWARDS[2] = {10, 100, 10}